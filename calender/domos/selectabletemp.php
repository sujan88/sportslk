		...
		var calendar = $('#check').fullCalendar({
			...
			select: function(start, end, allDay) {
				...
				if (title) {
					...
					window.location = "getdate.php?title="+title+"&start="+start+"&end="+end+"&allDay="+allDay;
				}
...
<style type='text/css'>
	...
	body {
		background:url(../../images/weight-lifter.png);
		margin-top: 40px;
		text-align: center;
		font-size: 14px;
...
<h4 >Weightlifting tournament calander</h4>
