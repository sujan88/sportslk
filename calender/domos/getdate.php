...
/////////////<!-- Include Database connections info. -->//////////////////
	...
	if ( $dateIsset ) {
		...
		header("Location:selectabletemp.php");
	}

     
		 $query2 = ("INSERT INTO $tbl_name (sdate,tittle,edate) VALUES ('{$editSdate}','{$title}','{$editEdate}')");
       ...
       // echo $query2;
		...
		header("Location:selectabletemp.php");/////////////// has to change///////////////
		mysql_close($con);
        ?>
