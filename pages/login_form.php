	 ...
	 <form method="post" action="Profile.php"  onSubmit="return validateForm3()"><br/><br />
    ...
    function validateForm3()
{
	...
	return isValid;
	 ...
	 <div style="text-align:center" >if you are not a member of our site plase <a href="signin.php" style="font-size:16px; color:#900">click here </a>to register. </div>
	 </p>
	 </form>