...
<?php 
	...
	mysql_select_db("$db_name") or die ("Cannot select DB");
		...
		$result = mysql_query("select * from $tbl_name where school_Name = 'Darmaraja Vidyalaya' ",$con);
 ...
 ?>
   ...
   <script type="text/javascript">
	...
	mysql_select_db("$db_name") or die ("Cannot select DB");
		...
		$result2 = mysql_query("select sport_ID from school_sport where school_ID = 3");
...
<td height="78"><div align="center" onclick="http://www.Rahula.org">Visit Darmaraja websight to get more information</div></td>
</tr>
</table>
</center>
</div>
